...
camembertbio_oof_probs.npy / camembertbio_test_probs.npy. Run: python finetune_camembert_bio.py
"""
import os
...
print(f"device {dev} | {MODEL} | maxlen {MAX_LEN} batch {BATCH} epochs {EPOCHS} | bio+tweet")
...
print("Tokenizing bio+tweet pairs...")
...
np.save(os.path.join(HERE, "camembertbio_oof_probs.npy"), oof)
np.save(os.path.join(HERE, "camembertbio_test_probs.npy"), test_probs)
...
print("Saved camembertbio_oof_probs.npy / camembertbio_test_probs.npy for blending.")
